...
> **Catalog Statistics:** **179 Requirements Verified** across **809 Test Proofs** (151 Functional Capabilities, 28 Safety Guardrails).
...
| :--- | :--- | :---: | :---: | :---: | :---: |
| **`AUTH`** | Authentication, RBAC & Identity | **39** | 37 | 2 | 205 proofs |
| **`CORE`** | CORE | **1** | 1 | 0 | 2 proofs |
| **`DB`** | Multi-Database Persistence & Migrations | **3** | 3 | 0 | 31 proofs |
| **`DOC`** | DOC | **4** | 4 | 0 | 4 proofs |
| **`GUARD`** | Universal Safety & Fail-Closed Guardrails | **16** | 0 | 16 | 133 proofs |
| **`MCP`** | Model Context Protocol Engine & Tool Routing | **49** | 49 | 0 | 149 proofs |
| **`SEC`** | Secrets Providers & Encryption | **38** | 30 | 8 | 127 proofs |
| **`TRANS`** | Transports (SSE, HTTP, STDIO, Proxy) | **3** | 3 | 0 | 28 proofs |
| **`UI`** | Dashboard, Test Bench & Settings UI | **26** | 24 | 2 | 130 proofs |
...
* **Verification Proofs (48):**
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L310`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L310) (`Pipeline_AppKey_Create_And_Revoke`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L393`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L393) (`Pipeline_GET_AppKeys_Returns200`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L402`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L402) (`Pipeline_GET_AppKeysLimits_Returns200`)
  ...
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L213`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L213) (`opens and closes add client modal and resets created result`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L268`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L268) (`initializes with default state`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L340`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L340) (`loads app key limits`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L354`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L354) (`handles fetch error gracefully without crashing`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L418`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L418) (`handles create key error with toast and throws`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L493`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L493) (`handles revoke failure with error toast`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L511`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L511) (`loads user quotas and updates store`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L529`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L529) (`handles fetchUserQuotas error gracefully without crashing`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L568`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L568) (`handles setUserQuota error with toast and throws`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L639`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L639) (`handles deleteUserQuota failure with error toast`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L657`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L657) (`opens and closes create modal and clears result`)
...
* **Verification Proofs (26):**
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L357`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L357) (`Pipeline_GET_Permissions_Mappings_Returns200`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L375`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L375) (`Pipeline_GET_Providers_Auth_Returns200`)
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L654`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L654) (`AuthMiddleware_Allows_SSO_Session_With_RemoteUser_Header`)
...
* **Type:** Positive Feature Capability
* **Verification Proofs (1):**
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SingleUserHomelabTests.cs#L35`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SingleUserHomelabTests.cs#L35) (`Homelab_ZeroConfigStartup_SeedsAdminAndClientKeys_AndPersistsFiles`)

### `[AUTH-36]` Pre-configured MCG_CLIENT_APP_KEYS seeds functional individualized client keys with custom scopes
* **Category:** `AUTH` (Authentication, RBAC & Identity)
* **Type:** Positive Feature Capability
* **Verification Proofs (1):**
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SingleUserHomelabTests.cs#L103`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SingleUserHomelabTests.cs#L103) (`Homelab_PreConfiguredClientKeys_SeedsIndividualizedScopedKeys`)

### `[AUTH-37]` AppKeys with server and category scopes enforce precise tool execution boundaries
* **Category:** `AUTH` (Authentication, RBAC & Identity)
* **Type:** Positive Feature Capability
* **Verification Proofs (1):**
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SingleUserHomelabTests.cs#L173`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SingleUserHomelabTests.cs#L173) (`AppKey_ScopeExtraction_ExtractsSemanticPrefixes`)

### `[AUTH-38]` LAN CIDR network configuration allows standalone web dashboard access from local subnet
* **Category:** `AUTH` (Authentication, RBAC & Identity)
* **Type:** Positive Feature Capability
* **Verification Proofs (1):**
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SingleUserHomelabTests.cs#L188`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SingleUserHomelabTests.cs#L188) (`Standalone_LanCidr_GrantsAdminAccessToLocalSubnet`)

### `[AUTH-39]` Zero-config startup defaults enterprise auth providers and secret providers to disabled
* **Category:** `AUTH` (Authentication, RBAC & Identity)
* **Type:** Positive Feature Capability
* **Verification Proofs (1):**
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SingleUserHomelabTests.cs#L216`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SingleUserHomelabTests.cs#L216) (`ZeroConfig_Startup_DefaultsEnterpriseProviders_ToDisabled`)
...
* **Verification Proofs (6):**
  ...
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L303`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L303) (`loads app keys and updates store`)
...
* **Verification Proofs (6):**
  ...
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L546`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L546) (`sets user quota override and refreshes quota list`)
...
* **Verification Proofs (10):**
  ...
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L287`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L287) (`switches keyTypeTab between personal and system`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L321`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L321) (`fetches system-filtered app keys via query parameters`)
...
* **Verification Proofs (60):**
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L267`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L267) (`Pipeline_Server_CRUD_Endpoints`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L321`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L321) (`Pipeline_GET_Version_Returns200`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L330`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L330) (`Pipeline_GET_Servers_Returns200`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L420`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L420) (`Pipeline_GET_Stats_Returns200`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L429`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L429) (`Pipeline_GET_Health_Returns200`)
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L269`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L269) (`PolymorphicDeserialization_Correctly_Deserializes_JsonRpcMessage_Subclasses`)
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L323`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L323) (`Serializing_Plain_JsonRpcMessage_Does_Not_Cause_StackOverflow`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L342`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L342) (`TestInitializationDiagnostics`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L905`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L905) (`ErrorTransformation_Cancellation_And_Sampling_Works_Correctly`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L1094`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L1094) (`CustomFilesDirectoryHelper_CreatesDirectoriesCorrectly`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L1109`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L1109) (`SessionManager_PerServerCache_WorksCorrectly`)
...
* **Verification Proofs (4):**
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L373`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L373) (`ToolListing_And_Remapping_Works_Correctly`)
...
* **Verification Proofs (10):**
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L436`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L436) (`ResourceRouting_And_UriTranslation_Works_Correctly`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L792`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L792) (`BuiltInResources_Templates_And_Autocompletion_Works_Correctly`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L1002`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L1002) (`CustomUserPrompts_And_Resources_Work_Correctly`)
...
* **Type:** Positive Feature Capability
* **Verification Proofs (3):**
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L524`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L524) (`PromptListAggregation_And_Routing_Works_Correctly`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L878`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L878) (`MetaPrompts_Works_Correctly`)
...
* **Verification Proofs (18):**
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/DynamicEmbeddingServiceTests.cs#L193`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/DynamicEmbeddingServiceTests.cs#L193) (`GenerateEmbeddingAsync_Uses_UnderlyingProvider`)
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/OnnxEmbeddingServiceTests.cs#L33`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/OnnxEmbeddingServiceTests.cs#L33) (`CosineSimilarity_CalculatesOrthogonalAndIdenticalVectors`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/OnnxEmbeddingServiceTests.cs#L51`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/OnnxEmbeddingServiceTests.cs#L51) (`GetEmbeddingAsync_ReturnsEmpty384Vector_ForEmptyString`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SemanticSearchServiceTests.cs#L41`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SemanticSearchServiceTests.cs#L41) (`SearchToolsSemanticAsync_ScoresAndRanksTools`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SemanticSearchServiceTests.cs#L60`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SemanticSearchServiceTests.cs#L60) (`SearchTools_KeywordMatching_WorksCorrectly`)
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L693`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L693) (`SemanticToolSearchRanking_Sorts_By_Score`)
...
* **Verification Proofs (27):**
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L366`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L366) (`Pipeline_GET_Providers_Secret_Returns200`)
...
* **Verification Proofs (5):**
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L472`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L472) (`Pipeline_POST_MasterKey_RejectsWhenExternalKeySource`)
...
* **Verification Proofs (12):**
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/ConcurrentResponseIsolationTests.cs#L552`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/ConcurrentResponseIsolationTests.cs#L552) (`ClientSession_TargetedCancellation_DoesNotCancelOtherClientsReusingId`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/ConcurrentResponseIsolationTests.cs#L621`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/ConcurrentResponseIsolationTests.cs#L621) (`ConcurrentResponseIsolation_MixedNumericStringNullIds`)
...
* **Verification Proofs (61):**
  ...
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/api/typedApi.test.ts#L64`](file:////containers/dev/csharp-mcp-router/frontend/src/test/api/typedApi.test.ts#L64) (`calls client and appkey endpoints correctly`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/api/typedApi.test.ts#L111`](file:////containers/dev/csharp-mcp-router/frontend/src/test/api/typedApi.test.ts#L111) (`calls user quota endpoints correctly`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/api/typedApi.test.ts#L140`](file:////containers/dev/csharp-mcp-router/frontend/src/test/api/typedApi.test.ts#L140) (`calls policies and mappings endpoints correctly`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/api/typedApi.test.ts#L167`](file:////containers/dev/csharp-mcp-router/frontend/src/test/api/typedApi.test.ts#L167) (`calls settings, providers, custom files, approvals endpoints correctly`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/api/typedApi.test.ts#L223`](file:////containers/dev/csharp-mcp-router/frontend/src/test/api/typedApi.test.ts#L223) (`calls testbench tool, prompt, resource, log endpoints correctly`)
...
* **Type:** Positive Feature Capability
* **Verification Proofs (3):**
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L244`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L244) (`Pipeline_Settings_Branding_ReadWrite`)
...
* **Type:** Positive Feature Capability
* **Verification Proofs (1):**
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L438`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L438) (`Branding_Logo_Upload_And_Retrieval_Works`)
...
* **Verification Proofs (47):**
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L295`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L295) (`Pipeline_Permissions_Policy_And_Mapping_CRUD`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L339`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L339) (`Pipeline_GET_Clients_Returns200`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L348`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L348) (`Pipeline_GET_Permissions_Policies_Returns200`)
...
* **Verification Proofs (9):**
  ...
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L373`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L373) (`creates category-scoped key, captures one-time plaintext key, and refreshes`)
...
* **Verification Proofs (42):**
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/ConcurrentResponseIsolationTests.cs#L585`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/ConcurrentResponseIsolationTests.cs#L585) (`JsonRpcStateManager_Disconnect_PreventsRegistrationAndCancelsPending`)
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L616`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L616) (`AuthMiddleware_Blocks_Unauthorized_Request`)
...
* **Verification Proofs (24):**
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L99`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L99) (`AuditLogger_AuditFailClosed_RefusesInvocation_OnAuditWriteError`)
...
* **Verification Proofs (16):**
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L68`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L68) (`McpClient_NamedHttpClient_Applies_SsrfConnectCallback_AndBlocksPrivateIps`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L1079`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L1079) (`CustomFilesSanitization_PreventsDirectoryTraversal`)
...
* **Verification Proofs (28):**
  ...
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L384`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L384) (`Pipeline_GET_Audit_Returns200`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L411`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L411) (`Pipeline_GET_Logs_Returns200`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L138`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L138) (`AuditLogger_RecordsPerRequestActor_NotHandshakeActor`)
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L1144`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L1144) (`Mcp_SessionId_IsOpaque_NotBearerToken`)
...
* **Verification Proofs (16):**
  ...
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L439`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L439) (`confirms and revokes AppKey and refreshes list`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L468`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L468) (`cancels revocation when confirm is rejected`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L584`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L584) (`prompts confirmation modal and resets user quota when confirmed`)
  - [Frontend Vitest] [`/containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L614`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L614) (`cancels quota reset when user denies confirmation`)
...
| `AUTH-35` | Positive | `AUTH` | Single-user homelab startup initializes SQLite, auto-generates Admin and Client AppKeys without PFX certificate requirements | [`SingleUserHomelabTests.cs:L35`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SingleUserHomelabTests.cs#L35) | Backend xUnit |
| `AUTH-36` | Positive | `AUTH` | Pre-configured MCG_CLIENT_APP_KEYS seeds functional individualized client keys with custom scopes | [`SingleUserHomelabTests.cs:L103`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SingleUserHomelabTests.cs#L103) | Backend xUnit |
| `AUTH-37` | Positive | `AUTH` | AppKeys with server and category scopes enforce precise tool execution boundaries | [`SingleUserHomelabTests.cs:L173`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SingleUserHomelabTests.cs#L173) | Backend xUnit |
| `AUTH-38` | Positive | `AUTH` | LAN CIDR network configuration allows standalone web dashboard access from local subnet | [`SingleUserHomelabTests.cs:L188`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SingleUserHomelabTests.cs#L188) | Backend xUnit |
| `AUTH-39` | Positive | `AUTH` | Zero-config startup defaults enterprise auth providers and secret providers to disabled | [`SingleUserHomelabTests.cs:L216`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/SingleUserHomelabTests.cs#L216) | Backend xUnit |
...
| `MCP-06` | Positive | `MCP` | prompts/list aggregates, namespaces, and routes prompts to target backends. | [`McpIntegrationTests.cs:L524`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/McpIntegrationTests.cs#L524) | Backend xUnit |
...
| `SEC-01` | Positive | `SEC` | SQLite database is encrypted at rest using SQLCipher with DB_ENCRYPTION_KEY. | [`DatabaseEncryptionTests.cs:L8`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/DatabaseEncryptionTests.cs#L8) | Backend xUnit |
...
| `UI-05` | Positive | `UI` | Router allows customized branding parameters (DashboardTitle, DashboardIcon) to be saved and retrieved via the API. | [`PipelineIntegrationTests.cs:L244`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L244) | Backend xUnit |
| `UI-06` | Positive | `UI` | Router supports uploading and retrieving custom branding logo images via dedicated endpoints. | [`PipelineIntegrationTests.cs:L438`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L438) | Backend xUnit |
...
| `UI-31` | Positive | `UI` | Fetches registered OAuth clients and updates store state. | [`useClientStore.test.ts:L37`](file:////containers/dev/csharp-mcp-router/frontend/src/test/stores/useClientStore.test.ts#L37) | Frontend Vitest |

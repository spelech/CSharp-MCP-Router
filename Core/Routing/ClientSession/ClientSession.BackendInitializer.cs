        ...
        public async Task EnsureBackendsInitializedAsync()
        {
            if (_initializeTask == null)
            {
                lock (_initLock)
                {
                    if (_initializeTask == null)
                    {
                        var initReq = "{\"jsonrpc\":\"2.0\",\"method\":\"initialize\",\"id\":\"auto-init\",\"params\":{\"protocolVersion\":\"2024-11-05\",\"capabilities\":{},\"clientInfo\":{\"name\":\"ModelContextGatewayAuto\",\"version\":\"0.4.0\"}}}";
        ...
        public void StartInitialization(string initializeRequest)
        {
            lock (_initLock)
            {
                if (_initializeTask == null)
                {
                    ...
                    {
                        finalRequest = "{\"jsonrpc\":\"2.0\",\"method\":\"initialize\",\"id\":\"auto-init\",\"params\":{\"protocolVersion\":\"2024-11-05\",\"capabilities\":{},\"clientInfo\":{\"name\":\"ModelContextGatewayAuto\",\"version\":\"0.4.0\"}}}";
                    }
                ...
                try
                {
                    ...
                    using (var ctsInit = new CancellationTokenSource(TimeSpan.FromSeconds(5)))
                    {
                        var initReq = string.IsNullOrEmpty(_lastInitializeRequest)
                            ? "{\"jsonrpc\":\"2.0\",\"method\":\"initialize\",\"id\":\"auto-init\",\"params\":{\"protocolVersion\":\"2024-11-05\",\"capabilities\":{},\"clientInfo\":{\"name\":\"ModelContextGatewayAuto\",\"version\":\"0.4.0\"}}}"

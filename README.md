...
| :--- | :--- | :--- |
| **`v5.6.1`** | 2026-09-01 | chore(refactor): Fixed an empty catch block in `StdioTransport` JSON parsing, improving maintainability, logging empty catch block occurrences, and reducing risks from silent failures. |

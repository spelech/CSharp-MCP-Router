...
> **Catalog Statistics:** **184 Requirements Verified** across **831 Test Proofs** (154 Functional Capabilities, 30 Safety Guardrails).
...
* **Verification Proofs (27):**
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/StdioTransportTests.cs#L364`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L364) (`StdioTransport_ShouldPassSecretViaEnvironmentVariables_AndNotCommandLine`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/StdioTransportTests.cs#L449`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L449) (`StdioTransport_ShouldSanitizeAndMaskSecretsInLogs`)
...
* **Verification Proofs (12):**
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/StdioTransportTests.cs#L49`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L49) (`StdioTransport_SendRequestAsync_LogsWarningOnInvalidJson`)
...
* **Type:** Positive Feature Capability
* **Verification Proofs (5):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/StdioTransportTests.cs#L69`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L69) (`StdioTransport_ShouldInitializeAndCallToolSuccessfully`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/StdioTransportTests.cs#L190`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L190) (`StdioTransport_ShouldRouteStderrToLogs`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/StdioTransportTests.cs#L262`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L262) (`StdioTransport_ShouldSupportCancellationAndProcessTreeTermination`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/StdioTransportTests.cs#L347`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L347) (`StdioTransport_ParseCommandLine_Handles_Quotes_And_Spaces`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/StdioTransportTests.cs#L492`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L492) (`StdioTransport_ShouldDrainReaderStreamsToEOF_WhenProcessExitsImmediately`)
...
* **Verification Proofs (15):**
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/StdioTransportTests.cs#L414`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L414) (`StdioTransport_ShouldFailClosed_WhenSecretResolutionFails`)
...
* **Verification Proofs (13):**
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/StdioTransportTests.cs#L124`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L124) (`StdioTransport_ShouldThrowSecurityExceptionForUnsafeExecutable`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/StdioTransportTests.cs#L146`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L146) (`StdioTransport_ShouldThrowSecurityExceptionForShellExecutable`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/StdioTransportTests.cs#L168`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L168) (`StdioTransport_ShouldThrowOnInvalidExecutable`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/StdioTransportTests.cs#L230`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L230) (`StdioTransport_ShouldTimeoutOnSlowRequests`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/StdioTransportTests.cs#L309`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L309) (`StdioTransport_ShouldHandleUnexpectedExit`)
...
| `TRANS-03` | Positive | `TRANS` | STDIO transport spawns subprocess, handles JSON-RPC initialization and executes tool calls | [`StdioTransportTests.cs:L69`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L69) | Backend xUnit |

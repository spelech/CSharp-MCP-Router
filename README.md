...
| :--- | :--- | :--- |
| **`v3.0.1`** | 2026-08-07 | **Security Release: Hardcoded DB Encryption Key Fallback Fix.** Removed the hardcoded database encryption key fallback and replaced it with a dynamically generated, cryptographically secure, and persistent key fallback. |

...
| :--- | :--- | :--- |
| **`v3.0.1`** | 2026-08-06 | **Code Health Improvement.** Resolved code health issue by implementing and refactoring the `SearchResourcesAsync` method in `ResourceRoutingManager.cs` cleanly, ensuring there are no unused variables or code paths. |

...
namespace McpRouter.Tests
{
    public class PermissionsControllerTests : IDisposable
    {
        ...
        {
            var controller = new PermissionsController(_dbFactory, new Mock<McpRouter.Core.Logging.IAuditLogger>().Object);
        ...
        public async Task GetPolicies_Returns500_OnDbException()
        {
            ...
            var controller = new PermissionsController(mockFailingFactory.Object, new Mock<McpRouter.Core.Logging.IAuditLogger>().Object);

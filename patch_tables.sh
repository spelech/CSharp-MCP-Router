...
/CREATE TABLE IF NOT EXISTS AppKeys/ {
    print "                    CREATE TABLE IF NOT EXISTS UserServerCredentials ("
    print "                        Id TEXT PRIMARY KEY,"
    print "                        Username TEXT,"
    print "                        ServerId TEXT,"
    print "                        EncryptedSecretJson TEXT"
    print "                    );"
    print ""
    print $0
    next
...
/CREATE TABLE IF NOT EXISTS .AppKeys./ {
    print "                    CREATE TABLE IF NOT EXISTS `UserServerCredentials` ("
    print "                        `Id`                  VARCHAR(100) PRIMARY KEY,"
    print "                        `Username`            VARCHAR(200) NOT NULL,"
    print "                        `ServerId`            VARCHAR(100) NOT NULL,"
    print "                        `EncryptedSecretJson` LONGTEXT NULL"

...
> **Catalog Statistics:** **146 Requirements Verified** across **340 Test Proofs** (117 Functional Capabilities, 29 Safety Guardrails).
...
| **`SEC`** | Secrets Providers & Encryption | **38** | 29 | 9 | 64 proofs |
...
* **Type:** Negative / Safety Guardrail (Fail-Closed)
* **Verification Proofs (1):**
  - [Backend xUnit] [`/containers/dev/csharp-mcp-router/ModelContextGateway.Tests/AuthorizationControllerTests.cs#L556`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/AuthorizationControllerTests.cs#L556) (`RegisterClient_MissingApplicationType_ReturnsBadRequest`)
...
| `AUTH-118` | **Guardrail** | `SEC` | RegisterClient returns 400 Bad Request when application_type parameter is missing. | [`AuthorizationControllerTests.cs:L556`](file:////containers/dev/csharp-mcp-router/ModelContextGateway.Tests/AuthorizationControllerTests.cs#L556) | Backend xUnit |

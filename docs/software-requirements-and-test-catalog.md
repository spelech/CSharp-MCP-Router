...
> **Catalog Statistics:** **144 Requirements Verified** across **338 Test Proofs** (116 Functional Capabilities, 28 Safety Guardrails).
...
| :--- | :--- | :---: | :---: | :---: | :---: |
| **`AUTH`** | Authentication, RBAC & Identity | **28** | 25 | 3 | 92 proofs |
...
| **`SEC`** | Secrets Providers & Encryption | **36** | 29 | 7 | 60 proofs |
...
* **Type:** Positive Feature Capability
* **Verification Proofs (1):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/TransportsAuthShapeTests.cs#L200`](file:////app/ModelContextGateway.Tests/TransportsAuthShapeTests.cs#L200) (`Transports_Use_PassThroughToken_If_Allowed`)
...
* **Verification Proofs (4):**
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/AppKeysControllerTests.cs#L339`](file:////app/ModelContextGateway.Tests/AppKeysControllerTests.cs#L339) (`CreateAppKey_AllowsUnlimited_WhenLimitsAreZero`)
...
* **Type:** Positive Feature Capability
* **Verification Proofs (1):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/AppKeyAuthenticationTests.cs#L409`](file:////app/ModelContextGateway.Tests/AppKeyAuthenticationTests.cs#L409) (`CreateCredentialAsync_GeneratesCompactKeysWithSemanticPrefixes`)

### `[AUTH-CUSTOM-ADMIN-KEY-SEEDING]` Seeds custom MCG_ADMIN_AUTH_KEY when provided in configuration.
* **Category:** `AUTH` (Authentication, RBAC & Identity)
* **Type:** Positive Feature Capability
* **Verification Proofs (3):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/DatabaseSeederServiceTests.cs#L186`](file:////app/ModelContextGateway.Tests/DatabaseSeederServiceTests.cs#L186) (`Startup_SeedsCustomAdminKey_WhenConfigured`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/DatabaseSeederServiceTests.cs#L238`](file:////app/ModelContextGateway.Tests/DatabaseSeederServiceTests.cs#L238) (`Startup_SeedsCustomAdminKey_WhenMcgAdminKeyConfigured`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/DatabaseSeederServiceTests.cs#L289`](file:////app/ModelContextGateway.Tests/DatabaseSeederServiceTests.cs#L289) (`Startup_UpdatesAdminKeyHash_WhenEnvironmentKeyChanges`)
...
* **Verification Proofs (6):**
  ...
  - [Frontend Vitest] [`/app/frontend/src/test/stores/useClientStore.test.ts#L267`](file:////app/frontend/src/test/stores/useClientStore.test.ts#L267) (`loads app keys and updates store`)
...
* **Verification Proofs (6):**
  ...
  - [Frontend Vitest] [`/app/frontend/src/test/stores/useClientStore.test.ts#L474`](file:////app/frontend/src/test/stores/useClientStore.test.ts#L474) (`sets user quota override and refreshes quota list`)
...
* **Type:** Positive Feature Capability
* **Verification Proofs (1):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/AppKeyAuthenticationTests.cs#L443`](file:////app/ModelContextGateway.Tests/AppKeyAuthenticationTests.cs#L443) (`ExtractKeyPrefix_ExtractsSemanticAndLegacyPrefixesAccurately`)
...
* **Verification Proofs (10):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/AppKeyAuthenticationTests.cs#L303`](file:////app/ModelContextGateway.Tests/AppKeyAuthenticationTests.cs#L303) (`PersonalAppKey_WithAllScope_DoesNotGrantAdministratorRole`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/AppKeyAuthenticationTests.cs#L356`](file:////app/ModelContextGateway.Tests/AppKeyAuthenticationTests.cs#L356) (`SystemAppKey_WithAdminScope_GrantsAdministratorRole`)
  ...
  - [Frontend Vitest] [`/app/frontend/src/test/stores/useClientStore.test.ts#L251`](file:////app/frontend/src/test/stores/useClientStore.test.ts#L251) (`switches keyTypeTab between personal and system`)
  - [Frontend Vitest] [`/app/frontend/src/test/stores/useClientStore.test.ts#L285`](file:////app/frontend/src/test/stores/useClientStore.test.ts#L285) (`fetches system-filtered app keys via query parameters`)
...
### `[DB-01]` IUserQuotaRepository persists user quota overrides and retrieves them correctly
...
* **Verification Proofs (10):**
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/DatabaseSeederServiceTests.cs#L332`](file:////app/ModelContextGateway.Tests/DatabaseSeederServiceTests.cs#L332) (`Seeder_Initializes_OAuthClients_Table`)
...
* **Type:** Positive Feature Capability
* **Verification Proofs (2):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/IdentityProviderTests.cs#L360`](file:////app/ModelContextGateway.Tests/IdentityProviderTests.cs#L360) (`TrustedProxyHelper_AllowsXForwardedFor_WhenChainIsFullyTrusted`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/IdentityProviderTests.cs#L419`](file:////app/ModelContextGateway.Tests/IdentityProviderTests.cs#L419) (`TrustedProxyHelper_ConfiguredProxyTrusted_CIDR`)
...
* **Verification Proofs (5):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L452`](file:////app/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L452) (`Pipeline_POST_MasterKey_RejectsWhenExternalKeySource`)
...
### `[UI-01]` Navigation tab bars use centered alignment across top bar and sub bars.
...
* **Type:** Positive Feature Capability
* **Verification Proofs (9):**
  - [Frontend Vitest] [`/app/frontend/src/test/components/ToolTesterCard.test.tsx#L101`](file:////app/frontend/src/test/components/ToolTesterCard.test.tsx#L101) (`displays fallback notice for complex non-object JSON schemas and allows switching to raw JSON tab`)
  - [Frontend Vitest] [`/app/frontend/src/test/components/ToolTesterCard.test.tsx#L142`](file:////app/frontend/src/test/components/ToolTesterCard.test.tsx#L142) (`renders initial server and tool selection options`)
  - [Frontend Vitest] [`/app/frontend/src/test/components/ToolTesterCard.test.tsx#L176`](file:////app/frontend/src/test/components/ToolTesterCard.test.tsx#L176) (`filters tools by selected server and handles tool change`)
  - [Frontend Vitest] [`/app/frontend/src/test/components/ToolTesterCard.test.tsx#L205`](file:////app/frontend/src/test/components/ToolTesterCard.test.tsx#L205) (`filters custom tools with no namespace prefix when selectedServer is custom`)
  - [Frontend Vitest] [`/app/frontend/src/test/components/ToolTesterCard.test.tsx#L230`](file:////app/frontend/src/test/components/ToolTesterCard.test.tsx#L230) (`renders dynamic fields for boolean, number, string, array, and object types`)
  - [Frontend Vitest] [`/app/frontend/src/test/components/ToolTesterCard.test.tsx#L277`](file:////app/frontend/src/test/components/ToolTesterCard.test.tsx#L277) (`renders empty state when selected tool takes no arguments`)
  - [Frontend Vitest] [`/app/frontend/src/test/components/ToolTesterCard.test.tsx#L302`](file:////app/frontend/src/test/components/ToolTesterCard.test.tsx#L302) (`switches to raw JSON tab and handles raw JSON editing`)
  - [Frontend Vitest] [`/app/frontend/src/test/components/ToolTesterCard.test.tsx#L341`](file:////app/frontend/src/test/components/ToolTesterCard.test.tsx#L341) (`handles form submission`)
...
* **Type:** Positive Feature Capability
* **Verification Proofs (1):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L240`](file:////app/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L240) (`Pipeline_Settings_Branding_ReadWrite`)

### `[UI-06]` Router supports uploading and retrieving custom branding logo images via dedicated endpoints.
* **Category:** `UI` (Dashboard, Test Bench & Settings UI)
* **Type:** Positive Feature Capability
* **Verification Proofs (1):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L418`](file:////app/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L418) (`Branding_Logo_Upload_And_Retrieval_Works`)
...
* **Type:** Positive Feature Capability
* **Verification Proofs (1):**
  - [Frontend Vitest] [`/app/frontend/src/test/components/ToolTesterCard.test.tsx#L1`](file:////app/frontend/src/test/components/ToolTesterCard.test.tsx#L1) (`renders fields from JSON Schema 2020-12 keywords (allOf, anyOf, $ref)`)
...
* **Type:** Positive Feature Capability
* **Verification Proofs (3):**
  - [Frontend Vitest] [`/app/frontend/src/test/components/ClientModal.test.tsx#L21`](file:////app/frontend/src/test/components/ClientModal.test.tsx#L21) (`renders client registration form with rich OAuth fields and cancel button`)
  - [Frontend Vitest] [`/app/frontend/src/test/components/ClientModal.test.tsx#L49`](file:////app/frontend/src/test/components/ClientModal.test.tsx#L49) (`submits registration form with parsed scopes array and OAuth metadata`)
  - [Frontend Vitest] [`/app/frontend/src/test/components/ClientModal.test.tsx#L88`](file:////app/frontend/src/test/components/ClientModal.test.tsx#L88) (`renders one-time secret display result card with copy buttons when createdClientResult is populated`)
...
* **Verification Proofs (5):**
  ...
  - [Frontend Vitest] [`/app/frontend/src/test/components/RegisteredClientsCard.test.tsx#L67`](file:////app/frontend/src/test/components/RegisteredClientsCard.test.tsx#L67) (`renders empty state when no registered clients exist`)
  - [Frontend Vitest] [`/app/frontend/src/test/components/RegisteredClientsCard.test.tsx#L84`](file:////app/frontend/src/test/components/RegisteredClientsCard.test.tsx#L84) (`renders rich client columns and handles client ID copy`)
  - [Frontend Vitest] [`/app/frontend/src/test/components/RegisteredClientsCard.test.tsx#L130`](file:////app/frontend/src/test/components/RegisteredClientsCard.test.tsx#L130) (`triggers deleteClient when Delete button is clicked`)
  - [Frontend Vitest] [`/app/frontend/src/test/stores/useClientStore.test.ts#L31`](file:////app/frontend/src/test/stores/useClientStore.test.ts#L31) (`fetches registered clients and updates state`)
...
* **Type:** Positive Feature Capability
* **Verification Proofs (1):**
  - [Frontend Vitest] [`/app/frontend/src/test/stores/useClientStore.test.ts#L64`](file:////app/frontend/src/test/stores/useClientStore.test.ts#L64) (`creates client with one-time secret result and refreshes list`)
...
### `[AUTH-01]` SecurityValidationHelper authorizes principals via Admin Group SID
* **Category:** `AUTH` (Authentication, RBAC & Identity)
* **Type:** Negative / Safety Guardrail (Fail-Closed)
* **Verification Proofs (15):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/IdentityProviderTests.cs#L220`](file:////app/ModelContextGateway.Tests/IdentityProviderTests.cs#L220) (`SecurityValidationHelper_IsAdmin_RequiresAdminGroupSid`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/IdentityProviderTests.cs#L238`](file:////app/ModelContextGateway.Tests/IdentityProviderTests.cs#L238) (`SecurityValidationHelper_IsAdmin_AllowsAdminGroupName`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/IdentityProviderTests.cs#L252`](file:////app/ModelContextGateway.Tests/IdentityProviderTests.cs#L252) (`SecurityValidationHelper_IsAdmin_RejectsNonAdminGroups`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/IdentityProviderTests.cs#L269`](file:////app/ModelContextGateway.Tests/IdentityProviderTests.cs#L269) (`SecurityValidationHelper_IsAdmin_AllowsCustomAdminGroupsArray`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/IdentityProviderTests.cs#L284`](file:////app/ModelContextGateway.Tests/IdentityProviderTests.cs#L284) (`SecurityValidationHelper_IsAdmin_AllowsMappedGroups`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/IdentityProviderTests.cs#L299`](file:////app/ModelContextGateway.Tests/IdentityProviderTests.cs#L299) (`OidcIdentityProvider_DoesNotGrantAdminSid_FromGroupOrUserNames`)
...
* **Verification Proofs (9):**
  ...
  - [Frontend Vitest] [`/app/frontend/src/test/stores/useClientStore.test.ts#L325`](file:////app/frontend/src/test/stores/useClientStore.test.ts#L325) (`creates category-scoped key, captures one-time plaintext key, and refreshes`)
...
### `[GUARD-02]` Throws InvalidOperationException when Vault master key retrieval fails.
* **Category:** `GUARD` (Universal Safety & Fail-Closed Guardrails)
* **Type:** Negative / Safety Guardrail (Fail-Closed)
...
* **Type:** Negative / Safety Guardrail (Fail-Closed)
* **Verification Proofs (1):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/ProvidersControllerTests.cs#L315`](file:////app/ModelContextGateway.Tests/ProvidersControllerTests.cs#L315) (`SaveAuthProvidersBatch_ReturnsBadRequest_WhenAllProvidersDisabled`)

### `[GUARD-06]` Global deny policies with TargetId '*' and IsAllowed false must fail closed
* **Category:** `GUARD` (Universal Safety & Fail-Closed Guardrails)
* **Type:** Negative / Safety Guardrail (Fail-Closed)
* **Verification Proofs (1):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/PermissionsControllerTests.cs#L227`](file:////app/ModelContextGateway.Tests/PermissionsControllerTests.cs#L227) (`SavePolicy_ReturnsBadRequest_WhenWildcardDenyPolicy`)
...
* **Type:** Negative / Safety Guardrail (Fail-Closed)
* **Verification Proofs (8):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L61`](file:////app/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L61) (`Pipeline_WellKnown_Endpoints_ReturnSuccess`)
...
* **Type:** Negative / Safety Guardrail (Fail-Closed)
* **Verification Proofs (1):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/ProviderSettingsEncryptionTests.cs#L379`](file:////app/ModelContextGateway.Tests/ProviderSettingsEncryptionTests.cs#L379) (`SaveSecretProvider_WhenDecryptionFailed_DoesNotOverwriteCorruptPayload`)

### `[UI-CONFIRM-MODAL]` Prompts confirmation modal and deletes server when confirmed.
* **Category:** `UI` (Dashboard, Test Bench & Settings UI)
* **Type:** Negative / Safety Guardrail (Fail-Closed)
* **Verification Proofs (14):**
  - [Frontend Vitest] [`/app/frontend/src/test/stores/useServerStore.test.ts#L203`](file:////app/frontend/src/test/stores/useServerStore.test.ts#L203) (`prompts window.confirm and deletes server when confirmed`)
  - [Frontend Vitest] [`/app/frontend/src/test/stores/useServerStore.test.ts#L232`](file:////app/frontend/src/test/stores/useServerStore.test.ts#L232) (`does not send delete request when confirm is cancelled`)
  - [Frontend Vitest] [`/app/frontend/src/test/stores/usePolicyStore.test.ts#L76`](file:////app/frontend/src/test/stores/usePolicyStore.test.ts#L76) (`deletes a policy when confirmed`)
  - [Frontend Vitest] [`/app/frontend/src/test/stores/usePolicyStore.test.ts#L105`](file:////app/frontend/src/test/stores/usePolicyStore.test.ts#L105) (`does not delete policy when confirm is cancelled`)
  - [Frontend Vitest] [`/app/frontend/src/test/stores/usePolicyStore.test.ts#L166`](file:////app/frontend/src/test/stores/usePolicyStore.test.ts#L166) (`deletes a group mapping when confirmed`)
  - [Frontend Vitest] [`/app/frontend/src/test/stores/usePolicyStore.test.ts#L195`](file:////app/frontend/src/test/stores/usePolicyStore.test.ts#L195) (`does not delete group mapping when confirm is cancelled`)
  - [Frontend Vitest] [`/app/frontend/src/test/stores/usePolicyStore.test.ts#L222`](file:////app/frontend/src/test/stores/usePolicyStore.test.ts#L222) (`deletes a custom file when confirmed`)
  - [Frontend Vitest] [`/app/frontend/src/test/stores/usePolicyStore.test.ts#L251`](file:////app/frontend/src/test/stores/usePolicyStore.test.ts#L251) (`does not delete custom file when confirm is cancelled`)
  - [Frontend Vitest] [`/app/frontend/src/test/stores/useClientStore.test.ts#L123`](file:////app/frontend/src/test/stores/useClientStore.test.ts#L123) (`prompts confirmation and deletes client when confirmed`)
  - [Frontend Vitest] [`/app/frontend/src/test/stores/useClientStore.test.ts#L152`](file:////app/frontend/src/test/stores/useClientStore.test.ts#L152) (`cancels deletion when user denies confirmation`)
  - [Frontend Vitest] [`/app/frontend/src/test/stores/useClientStore.test.ts#L385`](file:////app/frontend/src/test/stores/useClientStore.test.ts#L385) (`confirms and revokes AppKey and refreshes list`)
  - [Frontend Vitest] [`/app/frontend/src/test/stores/useClientStore.test.ts#L414`](file:////app/frontend/src/test/stores/useClientStore.test.ts#L414) (`cancels revocation when confirm is rejected`)
  - [Frontend Vitest] [`/app/frontend/src/test/stores/useClientStore.test.ts#L506`](file:////app/frontend/src/test/stores/useClientStore.test.ts#L506) (`prompts confirmation modal and resets user quota when confirmed`)
  - [Frontend Vitest] [`/app/frontend/src/test/stores/useClientStore.test.ts#L536`](file:////app/frontend/src/test/stores/useClientStore.test.ts#L536) (`cancels quota reset when user denies confirmation`)

### `[UI-TOAST-TRANSITION]` Displays error toast notification when switching from invalid JSON to Visual Prompt Builder.
* **Category:** `UI` (Dashboard, Test Bench & Settings UI)
* **Type:** Negative / Safety Guardrail (Fail-Closed)
* **Verification Proofs (8):**
  - [Frontend Vitest] [`/app/frontend/src/test/components/CustomFileModal.test.tsx#L88`](file:////app/frontend/src/test/components/CustomFileModal.test.tsx#L88) (`shows error toast when switching from invalid JSON to Visual Prompt Builder`)
  - [Frontend Vitest] [`/app/frontend/src/test/components/CustomFileModal.test.tsx#L109`](file:////app/frontend/src/test/components/CustomFileModal.test.tsx#L109) (`shows error toast when saving without a file name`)
  - [Frontend Vitest] [`/app/frontend/src/test/components/CustomFileModal.test.tsx#L129`](file:////app/frontend/src/test/components/CustomFileModal.test.tsx#L129) (`shows error toast when saving prompt with invalid JSON content`)
...
| `AUTH-01` | **Guardrail** | `AUTH` | SecurityValidationHelper authorizes principals via Admin Group SID | [`IdentityProviderTests.cs:L220`](file:////app/ModelContextGateway.Tests/IdentityProviderTests.cs#L220) | Backend xUnit |
| `AUTH-02` | Positive | `AUTH` | AppKey scopes restrict access precisely across all MCP capabilities and backend targets | [`PairwiseIntegrationMatrixTests.cs:L242`](file:////app/ModelContextGateway.Tests/PairwiseIntegrationMatrixTests.cs#L242) | Backend xUnit |
| `AUTH-03` | Positive | `AUTH` | SSO identity and group mappings resolve Windows SIDs and OIDC claims to internal access roles | [`PairwiseIntegrationMatrixTests.cs:L319`](file:////app/ModelContextGateway.Tests/PairwiseIntegrationMatrixTests.cs#L319) | Backend xUnit |
| `AUTH-04` | Positive | `AUTH` | ActiveDirectoryIdentityProvider extracts Windows caller SIDs and security groups via IWindowsIdentityAccessor and augments with LDAP | [`ActiveDirectoryWindowsIdentityTests.cs:L12`](file:////app/ModelContextGateway.Tests/ActiveDirectoryWindowsIdentityTests.cs#L12) | Backend xUnit |
...
| `AUTH-06` | Positive | `AUTH` | Transports use passThroughToken when AllowPassThroughAuth is true | [`TransportsAuthShapeTests.cs:L200`](file:////app/ModelContextGateway.Tests/TransportsAuthShapeTests.cs#L200) | Backend xUnit |
...
| `AUTH-105` | Positive | `AUTH` | Dynamic Auth Target Pass-Through | [`ToolRoutingManagerTests.cs:L173`](file:////app/ModelContextGateway.Tests/ToolRoutingManagerTests.cs#L173) | Backend xUnit |
...
| `AUTH-COMPACT-APPKEY-TAXONOMY` | Positive | `AUTH` | Generates compact ~32-character Base62 AppKeys with semantic prefixes. | [`AppKeyAuthenticationTests.cs:L409`](file:////app/ModelContextGateway.Tests/AppKeyAuthenticationTests.cs#L409) | Backend xUnit |
| `AUTH-CUSTOM-ADMIN-KEY-SEEDING` | Positive | `AUTH` | Seeds custom MCG_ADMIN_AUTH_KEY when provided in configuration. | [`DatabaseSeederServiceTests.cs:L186`](file:////app/ModelContextGateway.Tests/DatabaseSeederServiceTests.cs#L186) | Backend xUnit |
...
| `AUTH-PREFIX-EXTRACTION` | Positive | `AUTH` | ExtractKeyPrefix parses semantic prefixes, Base62 selectors, and legacy tokens accurately. | [`AppKeyAuthenticationTests.cs:L443`](file:////app/ModelContextGateway.Tests/AppKeyAuthenticationTests.cs#L443) | Backend xUnit |
...
| `AUTH-SYSTEM-APPKEY-SEPARATION` | Positive | `AUTH` | Personal AppKey with 'all' scope does not grant Administrator role | [`AppKeyAuthenticationTests.cs:L303`](file:////app/ModelContextGateway.Tests/AppKeyAuthenticationTests.cs#L303) | Backend xUnit |
...
| `DB-01` | Positive | `DB` | IUserQuotaRepository persists user quota overrides and retrieves them correctly | [`UserQuotaAndAppKeyRepositoryTests.cs:L85`](file:////app/ModelContextGateway.Tests/UserQuotaAndAppKeyRepositoryTests.cs#L85) | Backend xUnit |
...
| `GUARD-01` | **Guardrail** | `GUARD` | Null or empty capability targets must immediately fail closed and return unauthorized | [`PairwiseIntegrationMatrixTests.cs:L468`](file:////app/ModelContextGateway.Tests/PairwiseIntegrationMatrixTests.cs#L468) | Backend xUnit |
| `GUARD-02` | **Guardrail** | `GUARD` | Throws InvalidOperationException when Vault master key retrieval fails. | [`DbKeyHelperTests.cs:L283`](file:////app/ModelContextGateway.Tests/DbKeyHelperTests.cs#L283) | Backend xUnit |
| `GUARD-03` | **Guardrail** | `GUARD` | STDIO transport rejects commands with shell metacharacters or dangerous commands | [`StdioTransportTests.cs:L104`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L104) | Backend xUnit |
...
| `GUARD-05` | **Guardrail** | `GUARD` | Batch save of authentication providers must fail closed if all providers are disabled | [`ProvidersControllerTests.cs:L315`](file:////app/ModelContextGateway.Tests/ProvidersControllerTests.cs#L315) | Backend xUnit |
| `GUARD-06` | **Guardrail** | `GUARD` | Global deny policies with TargetId '*' and IsAllowed false must fail closed | [`PermissionsControllerTests.cs:L227`](file:////app/ModelContextGateway.Tests/PermissionsControllerTests.cs#L227) | Backend xUnit |
...
| `MCP-01` | Positive | `MCP` | Meta-mode execute_tool strictly enforces target tool authorization policies | [`PairwiseIntegrationMatrixTests.cs:L567`](file:////app/ModelContextGateway.Tests/PairwiseIntegrationMatrixTests.cs#L567) | Backend xUnit |
...
| `AUTH-111` | **Guardrail** | `SEC` | Pipeline exposes RFC 9728 OAuth Protected Resource discovery endpoints with dynamic resource identifiers. | [`PipelineIntegrationTests.cs:L61`](file:////app/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L61) | Backend xUnit |
...
| `SEC-01` | Positive | `SEC` | VaultSecretRetriever authenticates with HashiCorp Vault using AppRole RoleID and SecretID credentials | [`VaultAppRoleAndRenewalTests.cs:L14`](file:////app/ModelContextGateway.Tests/VaultAppRoleAndRenewalTests.cs#L14) | Backend xUnit |
| `SEC-02` | Positive | `SEC` | STDIO transport securely injects secret credentials via environment variables rather than command-line arguments | [`StdioTransportTests.cs:L344`](file:////app/ModelContextGateway.Tests/StdioTransportTests.cs#L344) | Backend xUnit |
| `SEC-03` | Positive | `SEC` | Ensure TrustedProxyHelper supports CIDR ranges in XFF validation | [`IdentityProviderTests.cs:L360`](file:////app/ModelContextGateway.Tests/IdentityProviderTests.cs#L360) | Backend xUnit |
| `SEC-04` | Positive | `SEC` | WindowsRegistrySecretRetriever securely decrypts DPAPI LocalMachine machine-level encrypted binary values and retrieves plaintext registry strings | [`WindowsRegistrySecretRetrieverTests.cs:L12`](file:////app/ModelContextGateway.Tests/WindowsRegistrySecretRetrieverTests.cs#L12) | Backend xUnit |
| `SEC-05` | **Guardrail** | `SEC` | Router must not overwrite corrupt encrypted database fields if an update occurs without user reset. | [`ProviderSettingsEncryptionTests.cs:L379`](file:////app/ModelContextGateway.Tests/ProviderSettingsEncryptionTests.cs#L379) | Backend xUnit |
...
| `SEC-MASTERKEY-ATOMIC-REENCRYPTION` | Positive | `SEC` | Rejects POST /api/config/master-key when key source is external. | [`PipelineIntegrationTests.cs:L452`](file:////app/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L452) | Backend xUnit |
...
| `TRANS-01` | Positive | `TRANS` | SSE transport resolves static plaintext API keys when provider is None | [`SseTransportTests.cs:L11`](file:////app/ModelContextGateway.Tests/SseTransportTests.cs#L11) | Backend xUnit |
| `TRANS-02` | Positive | `TRANS` | HTTP stateless transport resolves static API keys when secret provider is None | [`HttpTransportTests.cs:L11`](file:////app/ModelContextGateway.Tests/HttpTransportTests.cs#L11) | Backend xUnit |
...
| `UI-01` | Positive | `UI` | Navigation tab bars use centered alignment across top bar and sub bars. | [`LayoutCentering.test.tsx:L19`](file:////app/frontend/src/test/components/LayoutCentering.test.tsx#L19) | Frontend Vitest |
...
| `UI-04` | Positive | `UI` | Renders fallback notice and switch button for dynamic JSON schemas with no extractable properties | [`ToolTesterCard.test.tsx:L101`](file:////app/frontend/src/test/components/ToolTesterCard.test.tsx#L101) | Frontend Vitest |
| `UI-05` | Positive | `UI` | Router allows customized branding parameters (DashboardTitle, DashboardIcon) to be saved and retrieved via the API. | [`PipelineIntegrationTests.cs:L240`](file:////app/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L240) | Backend xUnit |
| `UI-06` | Positive | `UI` | Router supports uploading and retrieving custom branding logo images via dedicated endpoints. | [`PipelineIntegrationTests.cs:L418`](file:////app/ModelContextGateway.Tests/PipelineIntegrationTests.cs#L418) | Backend xUnit |
...
| `UI-103` | Positive | `UI` | Dynamic form generator renders fields extracted from JSON Schema 2020-12 keywords (allOf, anyOf, $ref) | [`ToolTesterCard.test.tsx:L1`](file:////app/frontend/src/test/components/ToolTesterCard.test.tsx#L1) | Frontend Vitest |
| `UI-109` | Positive | `UI` | Renders ClientSetupGuide below the user credentials card. | [`MyMcpServers.test.tsx:L102`](file:////app/frontend/src/test/pages/MyMcpServers.test.tsx#L102) | Frontend Vitest |
...
| `UI-30` | Positive | `UI` | Renders client registration form with inputs for name, client type, redirect URIs, grant types, scopes, and expiration. | [`ClientModal.test.tsx:L21`](file:////app/frontend/src/test/components/ClientModal.test.tsx#L21) | Frontend Vitest |
| `UI-31` | Positive | `UI` | Fetches clients on mount and renders table headers and action buttons. | [`RegisteredClientsCard.test.tsx:L42`](file:////app/frontend/src/test/components/RegisteredClientsCard.test.tsx#L42) | Frontend Vitest |
| `UI-32` | Positive | `UI` | Registers OAuth client with extended metadata (redirect URIs, grant types, client type, expiration) and captures one-time credentials. | [`useClientStore.test.ts:L64`](file:////app/frontend/src/test/stores/useClientStore.test.ts#L64) | Frontend Vitest |
| `UI-CONFIRM-MODAL` | **Guardrail** | `UI` | Prompts confirmation modal and deletes server when confirmed. | [`useServerStore.test.ts:L203`](file:////app/frontend/src/test/stores/useServerStore.test.ts#L203) | Frontend Vitest |
| `UI-TOAST-TRANSITION` | **Guardrail** | `UI` | Displays error toast notification when switching from invalid JSON to Visual Prompt Builder. | [`CustomFileModal.test.tsx:L88`](file:////app/frontend/src/test/components/CustomFileModal.test.tsx#L88) | Frontend Vitest |

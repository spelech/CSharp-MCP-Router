...
> **Catalog Statistics:** **184 Requirements Verified** across **832 Test Proofs** (154 Functional Capabilities, 30 Safety Guardrails).
...
| **`TRANS`** | Transports (SSE, HTTP, STDIO, Proxy) | **3** | 3 | 0 | 30 proofs |
...
* **Verification Proofs (13):**
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/SseTransportTests.cs#L72`](file:////app/ModelContextGateway.Tests/SseTransportTests.cs#L72) (`SendRequestAsync_HandlesWaitCancellationSafely`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/SseTransportTests.cs#L97`](file:////app/ModelContextGateway.Tests/SseTransportTests.cs#L97) (`CallMethodAsync_HandlesWaitCancellationSafely`)

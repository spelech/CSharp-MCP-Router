...
| :--- | :--- | :--- |
| **`v4.10.0`** | 2026-08-14 | feat(providers): make provider settings schema-consistent, encrypted at rest, secret-redacted, and dynamically effective at runtime (Issue #44) |

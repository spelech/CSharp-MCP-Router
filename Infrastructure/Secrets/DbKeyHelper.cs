        ...
        public static string ResolveDbEncryptionKey(IConfiguration configuration, ILogger? logger = null)
        {
            ...
            lock (_lock)
            {
                ...
                try
                {
                    ...
                    if (logger != null)
                    {
                        logger.LogInformation("[SECURITY] Auto-generated persistent master encryption key saved to '{KeyFilePath}'.", keyFilePath);
                        logger.LogInformation("[SECURITY] Backup this key to ensure recoverable access to encrypted credentials across storage re-provisioning.");
                    }

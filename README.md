...
![Version](https://img.shields.io/badge/version-v4.5.5-orange?style=for-the-badge)
...
| :--- | :--- | :--- |
| **`v4.5.5`** | 2026-08-10 | feat(deploy): lock trusted-proxy to loopback-only, add all-sink log sanitization, and DB migration scripts |

...
* **Verification Proofs (26):**
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L654`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L654) (`AuthMiddleware_Allows_SSO_Session_With_RemoteUser_Header`)
...
* **Verification Proofs (60):**
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L269`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L269) (`PolymorphicDeserialization_Correctly_Deserializes_JsonRpcMessage_Subclasses`)
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L323`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L323) (`Serializing_Plain_JsonRpcMessage_Does_Not_Cause_StackOverflow`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L342`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L342) (`TestInitializationDiagnostics`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L905`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L905) (`ErrorTransformation_Cancellation_And_Sampling_Works_Correctly`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L1094`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L1094) (`CustomFilesDirectoryHelper_CreatesDirectoriesCorrectly`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L1109`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L1109) (`SessionManager_PerServerCache_WorksCorrectly`)
...
* **Verification Proofs (4):**
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L373`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L373) (`ToolListing_And_Remapping_Works_Correctly`)
...
* **Verification Proofs (10):**
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L436`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L436) (`ResourceRouting_And_UriTranslation_Works_Correctly`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L792`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L792) (`BuiltInResources_Templates_And_Autocompletion_Works_Correctly`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L1002`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L1002) (`CustomUserPrompts_And_Resources_Work_Correctly`)
...
* **Type:** Positive Feature Capability
* **Verification Proofs (3):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L524`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L524) (`PromptListAggregation_And_Routing_Works_Correctly`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L878`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L878) (`MetaPrompts_Works_Correctly`)
...
* **Verification Proofs (19):**
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L693`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L693) (`SemanticToolSearchRanking_Sorts_By_Score`)
...
* **Verification Proofs (43):**
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L616`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L616) (`AuthMiddleware_Blocks_Unauthorized_Request`)
...
* **Verification Proofs (24):**
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L99`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L99) (`AuditLogger_AuditFailClosed_RefusesInvocation_OnAuditWriteError`)
...
* **Verification Proofs (16):**
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L68`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L68) (`McpClient_NamedHttpClient_Applies_SsrfConnectCallback_AndBlocksPrivateIps`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L1079`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L1079) (`CustomFilesSanitization_PreventsDirectoryTraversal`)
...
* **Verification Proofs (28):**
  ...
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L138`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L138) (`AuditLogger_RecordsPerRequestActor_NotHandshakeActor`)
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/McpIntegrationTests.cs#L1144`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L1144) (`Mcp_SessionId_IsOpaque_NotBearerToken`)
...
| `MCP-06` | Positive | `MCP` | prompts/list aggregates, namespaces, and routes prompts to target backends. | [`McpIntegrationTests.cs:L524`](file:////app/ModelContextGateway.Tests/McpIntegrationTests.cs#L524) | Backend xUnit |

...
> **Catalog Statistics:** **145 Requirements Verified** across **337 Test Proofs** (116 Functional Capabilities, 29 Safety Guardrails).
...
| **`SEC`** | Secrets Providers & Encryption | **37** | 29 | 8 | 61 proofs |
...
### `[AUTH-118]` RegisterClient returns 400 Bad Request when application_type parameter is missing.
* **Category:** `SEC` (Secrets Providers & Encryption)
* **Type:** Negative / Safety Guardrail (Fail-Closed)
* **Verification Proofs (1):**
  - [Backend xUnit] [`/app/ModelContextGateway.Tests/AuthorizationControllerTests.cs#L556`](file:////app/ModelContextGateway.Tests/AuthorizationControllerTests.cs#L556) (`RegisterClient_MissingApplicationType_ReturnsBadRequest`)
...
| `AUTH-118` | **Guardrail** | `SEC` | RegisterClient returns 400 Bad Request when application_type parameter is missing. | [`AuthorizationControllerTests.cs:L556`](file:////app/ModelContextGateway.Tests/AuthorizationControllerTests.cs#L556) | Backend xUnit |

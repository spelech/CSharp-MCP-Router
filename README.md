...
![Version](https://img.shields.io/badge/version-v5.5.3-orange?style=for-the-badge)
...
![Tests](https://img.shields.io/badge/tests-963%20passing-2ea44f?style=for-the-badge)
...
| :--- | :--- | :--- |
| **`v5.5.3`** | 2026-08-31 | chore(ci): Clean up unused using directive in `McpSpecMiddlewareTests.cs` and regenerate verified SRS requirements catalog (`MCP-21`) resolving CI Quality Gates and CodeQL formatting checks. |
